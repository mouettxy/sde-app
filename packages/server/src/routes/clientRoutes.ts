...
export class ClientRouter {
  ...
  public initializeRoutes(controller: any): void {
    ...
    this.expressRouter
      ...
      .post(`${path}/:id/auth/ping`, controller.ping)
      .post(`${path}/:id/auth/token`, controller.getToken)
      .post(`${path}/:id/client-address`, controller.addAddress)
      .post(`${path}/:id/client-order`, controller.addOrder)
